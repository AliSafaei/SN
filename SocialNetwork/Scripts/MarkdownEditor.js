...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.quote = makeButton("wmd-quote-button", "Blockquote - Ctrl+Q", "fa fa-quote-right", bindCommand("doBlockquote"), group2);
            buttons.code = makeButton("wmd-code-button", "Code Sample - Ctrl+K", "fa fa-code", bindCommand("doCode"), group2);
           // buttons.image = makeButton("wmd-image-button", "Image - Ctrl+G", "fa fa-image-o", bindCommand(function (chunk, postProcessing) {
            //    return this.doLinkOrImage(chunk, postProcessing, true);
            // }), group2);
            buttons.image = makeButton("wmd-image-button", "Image - Ctrl+G", "fa fa-arrows-h", "farsi", group2);
