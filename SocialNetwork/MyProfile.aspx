<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.Master" CodeBehind="MyProfile.aspx.vb" Inherits="SocialNetwork.MyProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ShowInfo" style="text-align:center;margin-bottom:4px; height: 797px;" >
            ...
            <div style="display: block">
                <table border="0" style="width: 99%; border-collapse: collapse;">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" >
                                <div id="Posts" style="width:100%  !important;">
                                    <a id="me" href="#" onclick="ShowMore(0)" class="SubmitButtons">بیشتر</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
    ...
    <div id="ColR">
        <div id="TabOfProfile" >
            ...
            <ul class="tabNavigation">
                ...
                <li class="Vertical"><button runat="server" id="ImageButton1" class="btn btn-lg btn-success btn-default" >ایجاد تغییر</button></li>
            </ul>
        </div>
    </div>
